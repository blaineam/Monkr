...
const builtInDevices: DeviceMeta[] = [
	...
	// ─── Watch ───────────────────────────────────────────────
	// Frame art generated by tools/gen-watch-frames.mjs (SVG → PNG).
	// Screen px are 2× the ASC screenshot size so frames stay crisp.
	{
		id: 'apple-watch-series-10-46mm', name: 'Apple Watch Series 10 46mm', category: 'watch', brand: 'Apple',
		slug: 'apple-watch-series-10-46mm', pngW: 1052, pngH: 1572, svgW: 832, svgH: 992, year: 2024,
		notch: 'none',
		colors: [
			{ id: 'jet-black', name: 'Jet Black', slug: 'jet-black' },
			{ id: 'rose-gold', name: 'Rose Gold', slug: 'rose-gold' },
			{ id: 'silver', name: 'Silver', slug: 'silver' }
		]
	},
	{
		id: 'apple-watch-ultra-49mm', name: 'Apple Watch Ultra 49mm', category: 'watch', brand: 'Apple',
		slug: 'apple-watch-ultra-49mm', pngW: 1080, pngH: 1608, svgW: 820, svgH: 1004, year: 2024,
		notch: 'none',
		colors: [
			{ id: 'natural-titanium', name: 'Natural Titanium', slug: 'natural-titanium' },
			{ id: 'black-titanium', name: 'Black Titanium', slug: 'black-titanium' }
