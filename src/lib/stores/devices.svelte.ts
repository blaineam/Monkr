...
// Screen is always centered within the frame PNG unless screenTop/screenLeft
// override it:
...
//
// REGISTRY MERGE RULE (see devices.merge.js): the registry =
//   hand-tuned entries below  ⊕  generated entries from devices.generated.json
// (emitted by `npm run sync-bezels` from Apple's official Product Bezels —
// docs/APPLE-BEZELS.md). Hand-tuned entries ALWAYS win on id/slug collision,
// so curated names/geometry here override anything the sync tool generates.
// Don't hand-edit devices.generated.json or static/devices/manifest.json.
...
const builtInDevices: DeviceMeta[] = [
	...
	// ─── Watch ───────────────────────────────────────────────
	// Frame art: Apple's official Product Bezels (Apple Design Resources,
	// https://developer.apple.com/design/resources/ — see docs/APPLE-BEZELS.md).
	// Geometry measured from the PNG alpha channel with tools/measure-bezel.mjs:
	// the transparent screen cutout maps 1:1 to ASC screenshot pixels.
	// Series 11 46mm: 560×880 frame, cutout 416×496 @ (72,192), corner r≈112.
	// Ultra 3 49mm:   600×960 frame, cutout 422×514 @ (89,223), corner r≈124
	//                 (cutout = ASC 410×502 + 6px glass border on each side).
	// Slugs are kept as series-10/ultra for downstream DISPLAY_FOR mappings;
	// Series 10/11 46mm share the same case + 416×496 screen.
	{
		id: 'apple-watch-series-10-46mm', name: 'Apple Watch Series 11 46mm', category: 'watch', brand: 'Apple',
		slug: 'apple-watch-series-10-46mm', pngW: 560, pngH: 880, svgW: 416, svgH: 496, year: 2025,
		screenTop: 21.818, screenLeft: 12.857,
		notch: 'none',
		colors: [
			{ id: 'jet-black', name: 'Aluminum Jet Black + Sport Band Black', slug: 'jet-black' },
			{ id: 'rose-gold', name: 'Aluminum Rose Gold + Sport Band Light Blush', slug: 'rose-gold' },
			{ id: 'silver', name: 'Aluminum Silver + Sport Band Purple Fog', slug: 'silver' },
			{ id: 'space-gray', name: 'Aluminum Space Gray + Sport Band Black', slug: 'space-gray' },
			{ id: 'titanium-gold', name: 'Titanium Gold + Sport Band Light Blush', slug: 'titanium-gold' },
			{ id: 'titanium-natural', name: 'Titanium Natural + Sport Band Stone Gray', slug: 'titanium-natural' },
			{ id: 'titanium-slate', name: 'Titanium Slate + Sport Band Black', slug: 'titanium-slate' }
		]
	},
	{
		id: 'apple-watch-ultra-49mm', name: 'Apple Watch Ultra 3 49mm', category: 'watch', brand: 'Apple',
		slug: 'apple-watch-ultra-49mm', pngW: 600, pngH: 960, svgW: 422, svgH: 514, year: 2025,
		screenTop: 23.229, screenLeft: 14.833,
		notch: 'none',
		colors: [
			{ id: 'natural-titanium', name: 'Natural + Ocean Band Anchor Blue', slug: 'natural-titanium' },
			{ id: 'black-titanium', name: 'Black + Ocean Band Black', slug: 'black-titanium' },
			{ id: 'natural-alpine-loop', name: 'Natural + Alpine Loop Terra Cotta', slug: 'natural-alpine-loop' },
			{ id: 'black-trail-loop', name: 'Black + Trail Loop Black Charcoal', slug: 'black-trail-loop' }
		]
	},
...
// Apple official-bezel entries generated by tools/sync-bezels.mjs.
// Hand-tuned entries above win on id collision (merge rule in devices.merge.js).
const generatedDevices = generated.devices as unknown as DeviceMeta[];
const allDevices = mergeDevices(builtInDevices, generatedDevices);

class DeviceRegistry {
	devices = $state<DeviceMeta[]>(allDevices);
